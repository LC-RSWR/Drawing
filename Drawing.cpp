...
CDrawingApp::CDrawingApp() noexcept
{
...
// CDrawingApp 自定义加载/保存方法

void CDrawingApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CDrawingApp::LoadCustomState()
{
}

void CDrawingApp::SaveCustomState()
{
}
